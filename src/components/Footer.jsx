...
export default function Footer(){
    return (
        <footer style={{height: '200px', gap: '2rem'}} className="d-flex flex-column align-items-center justify-content-center">
            <div style={{width: '90vw'}} className='d-flex gap-4 align-items-center justify-content-center'>
